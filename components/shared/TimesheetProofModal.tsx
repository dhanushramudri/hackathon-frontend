                ...
                <table className="w-full text-[11px]">
                  <thead className="sticky top-0">
                    <tr className="bg-gray-50 border-b border-gray-200">
                      <th className="text-left font-semibold text-gray-500 px-2.5 py-1.5">Date</th>
                      <th className="text-left font-semibold text-gray-500 px-2.5 py-1.5">Logged</th>
                      <th className="text-left font-semibold text-gray-500 px-2.5 py-1.5">Expected</th>
                      <th className="text-left font-semibold text-gray-500 px-2.5 py-1.5">Day util.</th>
                    </tr>
                  </thead>
                  <tbody>
                    {rows.map((r) => (
                      <tr key={r.date} className="border-b border-gray-50 last:border-0">
                        <td className="px-2.5 py-1.5 text-gray-600">{r.date}</td>
                        <td className="px-2.5 py-1.5 text-gray-700 font-medium">{r.hours}h</td>
                        <td className="px-2.5 py-1.5 text-gray-400">{r.expected_hours > 0 ? `${r.expected_hours}h` : "off-cycle"}</td>
